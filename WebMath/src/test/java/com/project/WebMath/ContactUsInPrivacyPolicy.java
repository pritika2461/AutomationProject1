...
public class ContactUsInPrivacyPolicy
{
  ...
  public void privacyPolicy() throws InterruptedException, IOException 
  {
	   //Access the property file 
		...
		WebElement contact = driver.findElement(By.xpath("//a[@class=\"comet-button comet-button--ghost main-nav__button main-nav__button--contact\"]")); 
		contact.click();
		// Wait for second
		driver.wait(3000);
